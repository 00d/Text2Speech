...
public class MainActivity extends Activity implements
    ...
    // Define the spoken language; must install all of these on your phone for text to speech
    // Settings - Language & Input - Text-to-speech output - Preferred Engine Settings - Install voice data
